...
class MIMNCell(nn.Module):
    """Simplified MIMN cell implemented with PyTorch."""

    def __init__(self, controller_units, memory_size, memory_vector_dim, read_head_num, write_head_num,
                 output_dim=None, clip_value=20, batch_size=128, mem_induction=0, util_reg=0):
        super().__init__()
        ...
        controller_input_size = memory_vector_dim * (1 + read_head_num)
        self.controller = nn.GRUCell(controller_input_size, controller_units)
